<template>
  <div class="wrapper mt-3 m-0 p-0 pt-0">
    ...
    <form class=" container" method="POST" @submit.prevent="addProduct" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-12">
      ...
      <div class="row">
        <!-- <div class="col-md-12">
         ...
         <div class="col-md-12">
          <div class="form-group ">
            <label for="inputState"><h4>Color</h4></label>
            <select id="inputState" v-model="product.color" required class="form-control borderStyle">
              <option selected>Choose...</option>
              <option>Red</option>
              <option>Blue</option>
              <option>Black</option> 
         ...
         <div class="col-md-12">
           <div class="form-group">
            <label for="title"><h4>Size</h4></label>
             <select id="" v-model="product.size" required class="form-control borderStyle">
              <option selected>Choose...</option>
              <option>Large</option>
              <option>Small</option>
    ...
    <img :src="product.productImg" height="200" width="300" class="img-fluid">
  </div>
</template>
...
export default {
  ...
  methods: {
    async addProduct(event) {
      ...
      data.append("size", this.product.size);
      data.append("des", this.product.des);
      data.append("color", this.product.color);
      data.append("file", this.product.productImg);
      try {
        await authenticationService.product(data);
      } catch (error) {
        console.log(error);
      }
    },
...
.form-control:focus:invalid {
  border-bottom: 3px solid rgb(236, 166, 36) !important;
}
</style>